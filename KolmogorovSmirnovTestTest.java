...
public class KolmogorovSmirnovTestTest {
  ...
  //  @Test
    public static void testTwoSampleSmallSampleExact() {
        final KolmogorovSmirnovTest test = new KolmogorovSmirnovTest();
     ...
     */
   // @Test
    public static void testTwoSampleExactP() {
   ...
   // @Test
    public static void testTwoSampleApproximateCritialValues() {
        final double tol = .01;
        final double[] alpha = {
  ...
  //  @Test
   ...
   // @Test
    public static void testTwoSampleApproximateP() {
        final KolmogorovSmirnovTest test = new KolmogorovSmirnovTest();
     ...
     */
   // @Test(timeout=5000)
    public static void testTwoSampleProductSizeOverflow() {
        final int n = 50000;
    ...
    */
     ...
     */
    private static void checkExactTable(int n, int m, double criticalValue, double alpha) {
        final KolmogorovSmirnovTest test = new KolmogorovSmirnovTest();
     ...
     */
    private static void checkApproximateTable(int n, int m, double criticalValue, double alpha, double epsilon) {
        final KolmogorovSmirnovTest test = new KolmogorovSmirnovTest();
